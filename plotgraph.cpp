...
PlotGraph::PlotGraph(QWidget * parent) :  QWidget(parent)//QGraphicsView(parent)
{
	...
	wAx[0] = 1;wAx[1] = 2;wAx[2] = 3;wAx[3] = 4;wAx[4] = 5;
...
//	ticstypey = 0;
	...
	LogScale = new QMenu(QString::fromUtf8 ("\xD0\xA2\xD0\xB8\xD0\xBF\x20\xD0\xBA\xD0\xBE\xD0\xBE\xD1\x80\xD0\xB4\xD0\xB8\xD0\xBD\xD0\xB0\xD1\x82"),this);//tr("Axes Scale"),this);

	dflCnAc		= new QAction(QString::fromUtf8 ("\xD0\x9F\xD0\xBE\x20\xD1\x83\xD0\xBC\xD0\xBE\xD0\xBB\xD1\x87\xD0\xB0\xD0\xBD\xD0\xB8\xD1\x8E"),this);//tr("default"), this);
	SelectAction = new QAction (QString::fromUtf8 ("\xD0\x92\xD1\x8B\xD0\xB4\xD0\xB5\xD0\xBB\xD0\xB8\xD1\x82\xD1\x8C\x20\xD0\xBE\xD0\xB1\xD0\xBB\xD0\xB0\xD1\x81\xD1\x82\xD1\x8C"),this);//tr("Select"),this); // переход в режим выделения области на графике
	ZoomAction   = new QAction (QString::fromUtf8 ("\xD0\x9C\xD0\xB0\xD1\x81\xD1\x88\xD1\x82\xD0\xB0\xD0\xB1"),this);//tr("Zoom"),this); // переход в режим изменения масштаба
	PanAction = new QAction (QString::fromUtf8 ("\xD0\x9F\xD0\xB5\xD1\x80\xD0\xB5\xD0\xBC\xD0\xB5\xD1\x89\xD0\xB5\xD0\xBD\xD0\xB8\xD0\xB5"),this);//tr("Pan"),this); // переход в режим перемещения по плоскости графика
	DataCursorAction = new QAction (QString::fromUtf8 ("\xD0\xA3\xD1\x81\xD1\x82\xD0\xB0\xD0\xBD\xD0\xBE\xD0\xB2\xD0\xB8\xD1\x82\xD1\x8C\x20\xD0\xBA\xD1\x83\xD1\x80\xD1\x81\xD0\xBE\xD1\x80"),this);//tr("DataCursor"),this); // переход в режим отображения данных на графике

	Log_Lin_Y  = new QAction (QString::fromUtf8 ("\xD0\x9B\xD0\xB8\xD0\xBD\x2E\x2F\xD0\x9B\xD0\xBE\xD0\xB3\x2E\x20\xD0\xBC\xD0\xB0\xD1\x81\xD1\x82\xD0\xB0\xD0\xB1\x20\xD0\xBE\xD1\x81\xD0\xB8\x20\x59"),this);//tr("Log/Lin Scale Y"),this); // переключение между логарифмическим и линейным масштабом
	Log_Lin_X  = new QAction (QString::fromUtf8 ("\xD0\x9B\xD0\xB8\xD0\xBD\x2E\x2F\xD0\x9B\xD0\xBE\xD0\xB3\x2E\x20\xD0\xBC\xD0\xB0\xD1\x81\xD1\x82\xD0\xB0\xD0\xB1\x20\xD0\xBE\xD1\x81\xD0\xB8\x20\x58"),this);//tr("Log/Lin Scale X"),this); // переключение между логарифмическим и линейным масштабом
	...
	TicksTp = new QMenu (QString::fromUtf8 ("\xD0\x9A\xD0\xBE\xD0\xBE\xD1\x80\xD0\xB4\xD0\xB8\xD0\xBD\xD0\xB0\xD1\x82\xD0\xBD\xD1\x8B\xD0\xB5\x20\xD0\xBC\xD0\xB5\xD1\x82\xD0\xBA\xD0\xB8"),this);//tr("Axes ticks types"),this); // подменю выбора типов шкалы
	TicksX = new QMenu(QString::fromUtf8 ("\xD0\x94\xD0\xBB\xD1\x8F\x20\xD0\xBA\xD0\xBE\xD0\xBE\xD1\x80\xD0\xB4\xD0\xB8\xD0\xBD\xD0\xB0\xD1\x82\xD1\x8B\x20\x58"),this);//tr("X axis "), this); // подменю выбора типов шкалы
	TicksY = new QMenu(QString::fromUtf8 ("\xD0\x94\xD0\xBB\xD1\x8F\x20\xD0\xBA\xD0\xBE\xD0\xBE\xD1\x80\xD0\xB4\xD0\xB8\xD0\xBD\xD0\xB0\xD1\x82\xD1\x8B\x20\x59"),this);//tr("Y axis "), this); // подменю выбора типов шкалы


	XTicks0 = new QAction(QString::fromUtf8 ("\xD0\x9F\xD1\x80\xD0\xBE\xD1\x81\xD1\x82\xD0\xB0\xD1\x8F\x20\xD1\x88\xD0\xBA\xD0\xB0\xD0\xBB\xD0\xB0"),this);//tr("Simple scale"),this); //  мекти на оси X типа 0
	XTicks1 = new QAction(QString::fromUtf8 ("\xD0\xA8\xD0\xBA\xD0\xB0\xD0\xBB\xD0\xB0\x20\xD1\x81\x20\xD0\xB2\xD1\x8B\xD0\xBD\xD0\xB5\xD1\x81\xD0\xB5\xD0\xBD\xD0\xBD\xD1\x8B\xD0\xBC\x20\xD0\xBC\xD0\xBD\xD0\xBE\xD0\xB6\xD0\xB8\xD1\x82\xD0\xB5\xD0\xBB\xD0\xB5\xD0\xBC"),this);//tr("Factor scale "), this); //  мекти на оси X типа 1
	XTicks2 = new QAction(QString::fromUtf8 ("\xD0\x9D\xD1\x83\xD0\xBB\xD1\x8C\x20\xD1\x81\xD0\xBC\xD0\xB5\xD1\x89\xD0\xB5\xD0\xBD\x20\xD0\xB2\x20\xD0\xBD\xD0\xB0\xD1\x87\xD0\xB0\xD0\xBB\xD0\xBE"),this);//tr("Zero at begin "), this); //  мекти на оси X типа 2
	XTicks3 = new QAction(QString::fromUtf8 ("\xD0\x9D\xD1\x83\xD0\xBB\xD1\x8C\x20\xD1\x81\xD0\xBC\xD0\xB5\xD1\x89\xD0\xB5\xD0\xBD\x20\xD0\xB2\x20\xD1\x86\xD0\xB5\xD0\xBD\xD1\x82\xD1\x80\x20\xD1\x88\xD0\xBA\xD0\xB0\xD0\xBB\xD1\x8B"),this);//tr("Zero in center "), this); //  мекти на оси X типа 3

	YTicks0 = new QAction(QString::fromUtf8 ("\xD0\x9F\xD1\x80\xD0\xBE\xD1\x81\xD1\x82\xD0\xB0\xD1\x8F\x20\xD1\x88\xD0\xBA\xD0\xB0\xD0\xBB\xD0\xB0"),this);//tr("Simple scale"),this); //  мекти на оси X типа 0
	YTicks1 = new QAction(QString::fromUtf8 ("\xD0\xA8\xD0\xBA\xD0\xB0\xD0\xBB\xD0\xB0\x20\xD1\x81\x20\xD0\xB2\xD1\x8B\xD0\xBD\xD0\xB5\xD1\x81\xD0\xB5\xD0\xBD\xD0\xBD\xD1\x8B\xD0\xBC\x20\xD0\xBC\xD0\xBD\xD0\xBE\xD0\xB6\xD0\xB8\xD1\x82\xD0\xB5\xD0\xBB\xD0\xB5\xD0\xBC"),this);//tr("Factor scale "), this); //  мекти на оси X типа 1
	YTicks2 = new QAction(QString::fromUtf8 ("\xD0\x9D\xD1\x83\xD0\xBB\xD1\x8C\x20\xD1\x81\xD0\xBC\xD0\xB5\xD1\x89\xD0\xB5\xD0\xBD\x20\xD0\xB2\x20\xD0\xBD\xD0\xB0\xD1\x87\xD0\xB0\xD0\xBB\xD0\xBE"),this);//tr("Zero at begin "), this); //  мекти на оси X типа 2
	YTicks3 = new QAction(QString::fromUtf8 ("\xD0\x9D\xD1\x83\xD0\xBB\xD1\x8C\x20\xD1\x81\xD0\xBC\xD0\xB5\xD1\x89\xD0\xB5\xD0\xBD\x20\xD0\xB2\x20\xD1\x86\xD0\xB5\xD0\xBD\xD1\x82\xD1\x80\x20\xD1\x88\xD0\xBA\xD0\xB0\xD0\xBB\xD1\x8B"),this);//tr("Zero in center "), this); //  мекти на оси X типа 3

	
	/*YTicks0 = new QAction(QString::fromUtf8 (""),this);//tr("Simple scale"), this); //  мекти на оси X типа 0
	YTicks1 = new QAction(QString::fromUtf8 (""),this);//tr("Factor scale "), this); //  мекти на оси X типа 1
	YTicks2 = new QAction(QString::fromUtf8 (""),this);//tr("Zero at begin "), this); //  мекти на оси X типа 2
	YTicks3 = new QAction(QString::fromUtf8 (""),this);//tr("Zero in center "), this); //  мекти на оси X типа 3*/
	...
	graph2clipboard = new QAction(QString::fromUtf8("Copy graphs to clipboard"),this); // сохранить в буфер

	dftCnxMn->addSeparator();
	dftCnxMn->addAction(graph2clipboard);

	ShowParamWindow = new QAction(QString::fromUtf8("Show Parametrs"), this); // сохранить в буфер;
	dftCnxMn->addSeparator();
	dftCnxMn->addAction(ShowParamWindow);
	...
	connect(graph2clipboard, SIGNAL(triggered()), this, SLOT(getdata2clopboard()));
...
void PlotGraph::getdata2clopboard()
{
	...
	if(Xdata.N>0)
	{
		for(int ii = 0; ii<this->Xdata.x[0].N;ii++)
		{
			for(int jj = 0; jj<this->Xdata.N;jj++)
			{
				str.setNum(Xdata.x[jj].x[ii]);
				locText.append(str);
				locText.append(" ");
				str.setNum(Ydata.x[jj].x[ii]);
				locText.append(str);
				locText.append(" ");
			}
			locText.append(" \n");
		}
		clipboard->setText(locText);
	}
}
...
void PlotGraph::setNgrphx(int ngr ) // установить количество графиков (по умолчанию -1)
{
	...
	ui_ParWindow->ChanedId_spinBox->setRange(0, ngr-1);
}
...
void PlotGraph::DrawDataCursorLines(QPainter &painter)
{
	...
	vec2db lcrd;
	lcrd = getLocPos(beg_id_x, 0);
	selX1 = lcrd.x[0];
	lcrd = getLocPos(end_id_x, 0);
	selX2 += lcrd.x[0];
...
void PlotGraph::setFundata()
{
	...
	switch (aprxtype)
	{
	case LinearApproxOnSelectedData:
		LinApprx.Fun(locx, locy);
		break;
	case GaussApproxOnSelectedData:
		GssApprx.Fun(locx, locy);
		break;
	case LorentsApproxOnSelectedData:
		LorApprx.Fun(locx, locy);
		break;
	}
	lix.fsetlen(locx.N);
	liy.fsetlen(locx.N);
...
void PlotGraph::addPeakData()
{
	vecdb xx;	// аргумент аппроксимирующей функции
	vecdb ff;	// значения аппроксимирующей функции

	if ((chanel_id >= 0) && (chanel_id <= Xdata.N))
	{
		if (SelectedIds.x[chanel_id].N > 3)
		{
			xx.fsetlen(SelectedIds.x[chanel_id].N);
			ff.fsetlen(SelectedIds.x[chanel_id].N);

			Xdata.x[chanel_id].ind(SelectedIds.x[chanel_id], xx); // выбор в xx значений агрумента выбранного диапазона
			Ydata.x[chanel_id].ind(SelectedIds.x[chanel_id], ff); // выбор в ff значений интесивности выбранного диапазона
			...
			{
			case LinearApproxOnSelectedData:
				LinApprx.setdata(xx,ff);
				LinApprx.MinErrFind();
			//	setFundata();
				apprxpar.setlen(2);
				apprxsgpar.setlen(2);
				apprxpar.x[0] = LinApprx.a;
				apprxpar.x[1] = LinApprx.b;
				apprxsgpar.x[0] = LinApprx.sga;
				apprxsgpar.x[1] = LinApprx.sgb;
			...
			case LorentsApproxOnSelectedData:
				...
				apprxsgpar.setlen(5);
				apprxpar = LorApprx.X;
				apprxsgpar = LorApprx.X_;
				//setFundata3();
				break;
			}
			setFundata();
			for (int ii = 0; ii < apprxpar.N; ii++)
			{
				ui_ParWindow->ApproxPrm_tableWidget->item(ii, 1)->setText(QString().setNum(apprxpar.x[ii], 'g', 6));
				ui_ParWindow->ApproxPrm_tableWidget->item(ii, 2)->setText(QString().setNum(apprxsgpar.x[ii], 'g', 6));
			}
		}
	}
}

void PlotGraph::SetUpParWinwow()
{
	ParWindow = new QWidget(parent_ptr, 0);// окно с параметрами графика

	//CBoxApprxTypeSelect = new QComboBox(ParWindow);

	ui_ParWindow = new Ui::PltPrmWnd;

//	ActivePlot_bar = new QImage(ui_ParWindow->ActPltClr_widget); // прямоугольник с цветов активного графика

	//ActivePlot_bar->setGeometry(QRect(280, 30, 50, 20));

	ui_ParWindow->setupUi(ParWindow);

	ParWindow->setWindowFlag(Qt::WindowStaysOnTopHint);
	...
	connect(ui_ParWindow->ApproxType_comboBox, SIGNAL(currentIndexChanged(int)), this, SLOT(setUpApprxTblCnt(int)));
	connect(ui_ParWindow->ChanedId_spinBox, SIGNAL(valueChanged(int)), this, SLOT(setActiveChanel(int)));
	connect(ShowParamWindow, SIGNAL(triggered()), this, SLOT(ParWindowShow()));
	connect(ui_ParWindow->Data2Table_pushButton, SIGNAL(clicked()), this, SLOT(data2table()));
}


void PlotGraph::setUpLinTbl()
{
	QTableWidgetItem *item;
	
	ui_ParWindow->ApproxPrm_tableWidget->setRowCount(2);
	ui_ParWindow->ApproxPrm_tableWidget->clearContents();

	item = new QTableWidgetItem;
	item->setText(QString().fromLatin1("A", 1));
	ui_ParWindow->ApproxPrm_tableWidget->setItem(0, 0, item);
	item = new QTableWidgetItem;
	item->setText(QString().fromLatin1("B", 1));
	ui_ParWindow->ApproxPrm_tableWidget->setItem(1, 0, item);
	for (int ii =0;ii<2;ii++)
		for (int jj = 1 ;jj<3;jj++)
		{
			item = new QTableWidgetItem;
			ui_ParWindow->ApproxPrm_tableWidget->setItem(ii, jj, item);
		}
}


void PlotGraph::setUpGssTbl()
{
	QTableWidgetItem *item;

	ui_ParWindow->ApproxPrm_tableWidget->setRowCount(5);
	ui_ParWindow->ApproxPrm_tableWidget->clearContents();
	...
	ui_ParWindow->ApproxPrm_tableWidget->setItem(1, 0, item);
	item = new QTableWidgetItem;
	item->setText(QString().fromLatin1("C", 1));
	ui_ParWindow->ApproxPrm_tableWidget->setItem(2, 0, item);
	item = new QTableWidgetItem;
	item->setText(QString().fromLatin1("D", 1));
	ui_ParWindow->ApproxPrm_tableWidget->setItem(3, 0, item);
	item = new QTableWidgetItem;
	item->setText(QString().fromLatin1("E", 1));
	ui_ParWindow->ApproxPrm_tableWidget->setItem(4, 0, item);
...
void PlotGraph::setUpApprxTblCnt(int tp_in)
{
	aprxtype = tp_in;
	switch (aprxtype)
	{
...
void PlotGraph::setActiveChanel(int id_chn)
{
	if ((id_chn >= 0) && (id_chn < Xdata.N))
	{
		if ( chanel_id!=id_chn) ui_ParWindow->Data_tableWidget->clearContents();
		chanel_id = id_chn; // номер графика в обработке аппроксимации
		ui_ParWindow->PlotColor_widget->setcolor(clrs.x[chanel_id]);
	}
	ui_ParWindow->PlotColor_widget->update();
}

void PlotGraph::ParWindowShow() // вывеси окно с параметрами графика
{
	ParWindow->setVisible(true);
}

void PlotGraph::data2table()
{
	QTableWidgetItem *item;
	ui_ParWindow->Data_tableWidget->clearContents();
	ui_ParWindow->Data_tableWidget->setRowCount(Xdata.x[chanel_id].N);
	for (int ii = 0; ii < Xdata.x[chanel_id].N; ii++)
	{
		item = new QTableWidgetItem;
		ui_ParWindow->Data_tableWidget->setItem(ii, 0, item);
		item = new QTableWidgetItem;
		ui_ParWindow->Data_tableWidget->setItem(ii, 1, item);
	}
	for (int ii = 0; ii < Xdata.x[chanel_id].N; ii++)
	{
		ui_ParWindow->Data_tableWidget->item(ii, 0)->setText(QString().setNum(Xdata.x[chanel_id].x[ii], 'g', 6));;
		ui_ParWindow->Data_tableWidget->item(ii, 1)->setText(QString().setNum(Ydata.x[chanel_id].x[ii], 'g', 6));;
	}
	/*QTableWidgetItem *items,*itemx,*itemy;
	ui_ParWindow->Data_tableWidget->clearContents();
	ui_ParWindow->Data_tableWidget->setRowCount(Xdata.x[chanel_id].N);
	items = new QTableWidgetItem [2*Xdata.x[chanel_id].N];
	itemy = itemx = items;
	itemy += Xdata.x[chanel_id].N;
	for (int ii = 0; ii < Xdata.x[chanel_id].N; ii++)
	{
		itemx[ii].setText(QString().setNum(Xdata.x[chanel_id].x[ii], 'g', 6));
		itemy[ii].setText(QString().setNum(Ydata.x[chanel_id].x[ii], 'g', 6));
	}
	for (int ii = 0; ii < Xdata.x[chanel_id].N; ii++)
	{
		ui_ParWindow->Data_tableWidget->setItem(ii, 0, itemx++);
		ui_ParWindow->Data_tableWidget->setItem(ii, 1, itemy++);
	}
	itemx = itemy = items = 0x0;*/
	ui_ParWindow->PlotColor_widget->update();
}
